...
\begin{tabular}{*{5}{| m{2.7cm} }|}
\hline
Name & LOC & Size & \multicolumn{2}{p{5.4cm}|}{Time Taken}\\ \cline{4-5}
 & & & \multicolumn{1}{p{2.7cm}|}{\textsc{klee}} & \multicolumn{1}{p{2.7cm}|}{\textsc{leek}}\\ \hline
stuff & stuff & stuff & stuff & stuff\\ \hline
stuff & stuff & stuff & stuff & stuff\\ \hline
\end{tabular}
\end{center}
