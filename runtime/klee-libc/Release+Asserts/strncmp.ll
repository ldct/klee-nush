...
bb3:                                              ; preds = %bb1
  %7 = icmp eq i8 %1, 0, !dbg !21
  br i1 %7, label %bb7, label %bb5, !dbg !21

bb5:                                              ; preds = %bb3
  %8 = icmp eq i32 %tmp13, %indvar
  %indvar.next = add i32 %indvar, 1
  br i1 %8, label %bb7, label %bb1, !dbg !22
...
!0 = metadata !{i32 524334, i32 0, metadata !1, metadata !"strncmp", metadata !"strncmp", metadata !"strncmp", metadata !1, i32 37, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 true, i32 (i8*, i8*, i32)* @strncmp} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 524329, metadata !"strncmp.c", metadata !"/home/xuanji/klee-nush/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"strncmp.c", metadata !"/home/xuanji/klee-nush/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.8)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!12 = metadata !{i32 524545, metadata !0, metadata !"s1", metadata !1, i32 36, metadata !6} ; [ DW_TAG_arg_variable ]
!13 = metadata !{i32 524545, metadata !0, metadata !"s2", metadata !1, i32 36, metadata !6} ; [ DW_TAG_arg_variable ]
!14 = metadata !{i32 524545, metadata !0, metadata !"n", metadata !1, i32 36, metadata !9} ; [ DW_TAG_arg_variable ]
!15 = metadata !{i32 36, i32 0, metadata !0, null}
!16 = metadata !{i32 39, i32 0, metadata !17, null}
!17 = metadata !{i32 524299, metadata !0, i32 37, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!18 = metadata !{i32 42, i32 0, metadata !17, null}
!19 = metadata !{i32 43, i32 0, metadata !17, null}
!20 = metadata !{i32 40, i32 0, metadata !17, null}
