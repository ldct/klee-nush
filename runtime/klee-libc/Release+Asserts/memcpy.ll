...
bb:                                               ; preds = %entry, %bb
  ...
  br i1 %exitcond, label %bb2, label %bb, !dbg !22
...
!llvm.dbg.sp = !{!0}
!llvm.dbg.lv.memcpy = !{!9, !10, !11, !12, !16}

!0 = metadata !{i32 524334, i32 0, metadata !1, metadata !"memcpy", metadata !"memcpy", metadata !"memcpy", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 true, i8* (i8*, i8*, i32)* @memcpy} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 524329, metadata !"memcpy.c", metadata !"/home/xuanji/klee-nush/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/xuanji/klee-nush/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.8)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
