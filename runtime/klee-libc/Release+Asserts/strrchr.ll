...
entry:
  ...
  tail call void @llvm.dbg.value(metadata !{null}, i64 0, metadata !14), !dbg !19
  %l.06 = select i1 %2, i8* %t, i8* null
  %3 = icmp eq i8 %1, 0, !dbg !19
  br i1 %3, label %bb3, label %bb4, !dbg !19

bb3:                                              ; preds = %bb4, %entry
  %l.0.lcssa = phi i8* [ %l.06, %entry ], [ %l.0, %bb4 ]
  ret i8* %l.0.lcssa, !dbg !19

bb4:                                              ; preds = %entry, %bb4
  %indvar = phi i32 [ %tmp, %bb4 ], [ 0, %entry ]
  %l.08 = phi i8* [ %l.0, %bb4 ], [ %l.06, %entry ]
  %tmp = add i32 %indvar, 1
  %scevgep = getelementptr i8* %t, i32 %tmp
  %4 = load i8* %scevgep, align 1, !dbg !19
  %5 = icmp eq i8 %4, %0, !dbg !19
  %l.0 = select i1 %5, i8* %scevgep, i8* %l.08
...
!0 = metadata !{i32 524334, i32 0, metadata !1, metadata !"strrchr", metadata !"strrchr", metadata !"strrchr", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 true, i8* (i8*, i32)* @strrchr} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 524329, metadata !"strrchr.c", metadata !"/home/xuanji/klee-nush/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"strrchr.c", metadata !"/home/xuanji/klee-nush/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.8)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!10 = metadata !{i32 524545, metadata !0, metadata !"t", metadata !1, i32 12, metadata !7} ; [ DW_TAG_arg_variable ]
!11 = metadata !{i32 524545, metadata !0, metadata !"c", metadata !1, i32 12, metadata !9} ; [ DW_TAG_arg_variable ]
!12 = metadata !{i32 524544, metadata !13, metadata !"ch", metadata !1, i32 13, metadata !6} ; [ DW_TAG_auto_variable ]
!13 = metadata !{i32 524299, metadata !0, i32 12, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!14 = metadata !{i32 524544, metadata !13, metadata !"l", metadata !1, i32 14, metadata !7} ; [ DW_TAG_auto_variable ]
